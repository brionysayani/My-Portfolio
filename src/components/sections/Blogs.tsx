...
const Blogs = () => {
  const research = [
    {
      title: "Agentic Architecture Enabling Secure and Fault-Tolerant Telesurgery",
      snippet: "Designed an agentic AI architecture for secure satellite-assisted telesurgery, addressing DDoS attacks, latency, packet loss, and communication failures. The TinyML edge model achieved 94% validation accuracy with a compact 0.5 MB footprint.",
      date: "November 2025",
      color: "bg-custom-yellow",
      link: "https://ieeexplore.ieee.org/document/11580659",
    }
  ];

  return (
    <section id="research" className="py-10 px-4 max-w-7xl mx-auto w-full">
      <div className="flex items-center gap-4 mb-10">
        <div className="bg-custom-purple px-8 py-3 border-4 border-black shadow-neo  rounded-full">
          <h2 className="text-3xl font-shrikhand text-white">RESEARCH</h2>
        </div>
      </div>
